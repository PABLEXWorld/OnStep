...
#define PINMAP                    AMPIMPA //    OFF, Choose from: MksGenL2, MiniPCB2, MaxPCB2, MaxESP3, CNC3, STM32Blue,     <-Req'd
...
#define SLEW_RATE_BASE_DESIRED       2.00 //    1.0, n. Desired slew rate in deg/sec. Adjustable at run-time from            <-Req'd
...
#define AXIS1_STEPS_PER_DEGREE    42666.666666666667 //  12800, n. Number of steps per degree:                                          <-Req'd
...
#define AXIS2_STEPS_PER_DEGREE    42666.666666666667 //  12800, n. Number of steps per degree:                                          <-Req'd
                                          //         n = (stepper_steps * micro_steps * overall_gear_reduction)/360.0

#define AXIS2_DRIVER_MODEL        GENERIC //    OFF, (See above.) Stepper driver model.                                      <-Often
...
#define AXIS4_DRIVER_MICROSTEPS       128 //    OFF, n. Microstep mode when tracking.                   For TMC2130, TMC5160. Option
