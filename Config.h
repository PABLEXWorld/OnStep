...
// Slewing Speed: 9.62 degrees/second (estimated)
// Generated on: 2022-10-20 20:15
// ---------------------------------------------------------------------------------------------------------------------------------
...
#define PINMAP                     CNC3_BADCHIP  //     OFF, Choose from: MiniPCB, MiniPCB2, MaxPCB, MaxPCB2, STM32Blue,             <-Req'd
...
#define AXIS1_STEPS_PER_DEGREE    1754.0740740740700 //  12800, n. Number of steps per degree:                                          <-Req'd
...
#define AXIS2_STEPS_PER_DEGREE    1754.0740740740700 //  12800, n. Number of steps per degree:                                          <-Req'd
                                          //         n = (stepper_steps * micro_steps * overall_gear_reduction)/360.0
